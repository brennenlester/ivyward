...
| **Inventory** (status panel) | Browse materials, items, and the 4×4 crafting grid |
| **Recipes** (status panel) | See every shaped crafting pattern |
